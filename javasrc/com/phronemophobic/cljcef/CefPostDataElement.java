...
void set_to_file(CefPostDataElement x0, CefStringUtf16 x1); 
}
...
public void setToEmpty () {
  ...
  this.set_to_empty.set_to_empty(this);

}

public void setToFile (String x1) {

  this.set_to_file.set_to_file(this, CljCefLib.toCefString(x1));

}

public void setToBytes (SizeT x1, Pointer x2) {

  this.set_to_bytes.set_to_bytes(this,  x1,  x2);
...
public CefStringUtf16 getFile () {

return  this.get_file.get_file(this);

}

public SizeT getBytesCount () {

return  this.get_bytes_count.get_bytes_count(this);

}

public SizeT getBytes (SizeT x1, Pointer x2) {

return  this.get_bytes.get_bytes(this,  x1,  x2);
